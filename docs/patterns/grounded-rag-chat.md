# Pattern: Grounded RAG chat

Optional reference architecture for a document Q&A chatbot with citations. Use this when [project-brief.md](../project-brief.md) specifies a RAG chat product. For general system boundaries and repo conventions, see [architecture.md](../architecture.md).
